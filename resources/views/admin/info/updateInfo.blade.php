...
@section('adminContent')
    <div class="p-5">
        <div class="border-0 shadow-lg bg-light rounded col-md-12 py-4">
            <h4 class="text-center font-weight-bold pb-4">Mise à jour info service</h4>
            <form class="col-md-10 mx-auto" action="/admin/update-info/{{$updateInfo->id}}" method="post">
                @csrf
                <div class="form-group my-3 text-center">
                    <label for="titleInfo">Le titre</label>
                    <input class="col-12" name="titleInfo" id="titleInfo" value="{{ $updateInfo->title }}">
                </div>
                <div class="form-group my-3 text-center">
                    <label class="" for="messageInfo">Contenu</label>
                    <textarea class="InfoContent" name="messageInfo" id="messageInfo">{!! $updateInfo->content !!}</textarea>
                </div>
